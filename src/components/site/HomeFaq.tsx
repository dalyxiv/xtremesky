  ...
  return (
    <section id="faq" className="scroll-mt-24 border-t border-gold/15 bg-charcoal/35 px-6 py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <Link to="/plan-your-flight" hash="faqs" className="mt-8 inline-block text-sm text-[var(--gold-bright)] underline underline-offset-4">
          See all questions & planning guidance
        </Link>
      </div>
    </section>
  );
